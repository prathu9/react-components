...
const [StylesProvider, useStyles] = createStylesContext('StepperTheme')

export interface StepperProps
  extends UseStepperProps,
    Omit<HTMLChakraProps<'div'>, 'onChange'>,
    ThemingProps<'StepperTheme'> {
      ...
      <StylesProvider value={styles}>
        <StepperProvider value={context}>
          <chakra.div
            ...
            {...containerProps}
            className={cx('incmix-stepper', props.className)}
          >
            {children}
          </chakra.div>
        </StepperProvider>
  ...
  return (
    <>
      <chakra.div
        __css={stepperStyles}
        {...rest}
        className={cx('incmix-stepper__steps', props.className)}
      >
        {elements}
      </chakra.div>
      {content}
...
export const StepperContent: React.FC<StepperContentProps> = (props) => {
  ...
  return (
    <chakra.div
      ...
      {...rest}
      className={cx('incmix-stepper__content', props.className)}
    >
...
export const StepperIcon: React.FC<StepperIconProps> = (props) => {
  ...
  return (
    <chakra.div
      __css={iconStyles}
      {...rest}
      className={cx('incmix-stepper__icon', className)}
    >
      {content}
    </chakra.div>
  )
...
export const StepperStep: React.FC<StepperStepProps> = (props) => {
  ...
  return (
    <chakra.div
      ...
      className={cx('incmix-stepper__step', props.className)}
    >
...
export const StepperSeparator: React.FC<StepperSeparatorProps> = (props) => {
  ...
  return (
    <chakra.div
      ...
      className={cx('incmix-stepper__separator', props.className)}
...
export const StepperStepTitle: React.FC<HTMLChakraProps<'p'>> = (props) => {
  ...
  return (
    <chakra.p
      {...props}
      __css={styles.title}
      className={cx('incmix-stepper__title', props.className)}
    />
  )
}
...
export const StepperCompleted: React.FC<HTMLChakraProps<'div'>> = (props) => {
  ...
  return (
    <chakra.div
      ...
      {...props}
      className={cx('incmix-stepper__completed', props.className)}
    />
  )
}
